...
const showLess = () => setShowAll(false);
  ...
  if (showAll) {
    ...
    return <div id="changed" style={{paddingRight:""}}> 
      <Typography style={{fontFamily:"Montserrat",fontWeight:"600"}}>{content}</Typography> 
  ...
  return <div style={{paddingRight:""}}> 
   <Typography style={{fontFamily:'Montserrat',fontWeight:"600"}}> {toShow} </Typography> 
