        ...
        >
          ...
          >
            ...
            <span className="icons_in_sidebar" style={{marginLeft:"2em"}}>
              <Button style={{background:"#2f4f4f",fontWeight:"900",fontSize:"0.9em",boxShadow:"0px 3px 5px black",color:"white"}} >Message</Button>
            </span>
